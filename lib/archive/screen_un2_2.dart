...
class _ChatScreenState extends State<ChatScreen> {
  ...
  String _myName = "User";
  String _previousName = "User"; // Для отслеживания изменений имени
  ...
  Future<void> _initPreferences() async {
    ...
    // Устанавливаем _previousName равным _myName, чтобы избежать ложного срабатывания при первой загрузке
  ...
  Future<void> _connectToEsp32() async {
    ...
    try {
      ...
      // Показываем уведомление о подключении без лишних сообщений
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                if (newName.isNotEmpty && newName != _myName) {
                  ...
                  setState(() {
                    _myName = newName;
                    _previousName = newName; // Обновляем предыдущее имя
                  });
                  ...
                  // Не показываем уведомление здесь, так как ESP32 отправит подтверждение
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            color: Colors.white, // Явное задание цвета для этой конкретной иконки
          ),
